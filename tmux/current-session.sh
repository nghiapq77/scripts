...
sleep 0.2
tmux select-layout -t main:2 "ae7a,151x40,0,0{93x40,0,0[93x15,0,0,1,93x24,0,16,5],57x40,94,0,2}" > /dev/null
tmux new-window -n obj-mat -t main:3 -c /home/oz/projects/object-matching
sleep 0.2
tmux send-keys -t main:3.1 "source venv/bin/activate" Enter
tmux select-layout -t main:3 "ac43,151x40,0,0,6" > /dev/null
tmux new-window -n bash -t main:4 -c /home/oz/
sleep 0.2
tmux select-layout -t main:4 "5658,151x40,0,0,19" > /dev/null
tmux -2u att
